package com.loop.test.day10_jsexecutore_pom;
...
/*
    ...
    public void practice_drag_drop_test(){
        ...
        Actions avtion = new Actions(Driver.getDriver());
        avtion.moveToElement(smallCircle).clickAndHold().moveToElement(bigCircle).release().perform();
